...
<head>
	...
	<script type="text/javascript" >
		function checkIt() {
			...
			if(frm.id.value == "아이디" | frm.id.value == "") {
				alert("아이디를 입력해주세요.");
				...
				return false;
			} else if(frm.birth.value == "생년월일 6자리" | frm.birth.value == "") {
				alert("생년월일을 입력해주세요.");
...
<div class="title">
	...
	<!-- 로그인 허가 -->
	<s:if test="check == 1">
		<script type="text/javascript"> location.href="/SocialMap/socialMap.tiles"; </script>
	</s:if>
		...
		<form action="Find.action" method="post" name="form" enctype="multipart/form-data" onsubmit="return checkIt();">
			...
			<table style="margin: auto;">
				...
				<tr style="height: 60px;">
					<td><s:textfield name="id" theme="simple" maxlength="10" cssStyle="width:300px; height:30px;" value="아이디" onfocus="this.value=''" /></td>
				</tr>
				...
				<tr style="height: 60px;">
					<td><s:textfield name="birth" theme="simple" maxlength="6" cssStyle="width:300px; height:30px" value="생년월일 6자리" onfocus="this.value=''" /></td>
				</tr>
